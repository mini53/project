...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-4">
				<h4>BuildUP만의 특징</h4>
				<p>BuildUP은 직장인들을 위한 스터디 플랫폼 입니다.</p>
				<p><a class="btn btn-default" data-target="#modal" data-toggle="modal">자세히 알아보기</a></p>
			</div>
			<div class="col-md-4">
				<h4>간편한 스터디 구성</h4>
				<p>BuildUP은 빠르고, 쉽게 스터디를 구성할 수 있습니다.</p>
				<p><a class="btn btn-default" href="teamup.jsp">자세히 알아보기</a></p>
			</div>
			<div class="col-md-4">
				<h4>스터디 관리</h4>
				<p>BuildUP은 스터디 진행을 위한 스케쥴러를 제공 합니다.</p>
				<p><a class="btn btn-default" href="schedule.jsp">자세히 알아보기</a></p>
			</div>
		</div>
		<hr>
