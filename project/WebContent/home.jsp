...
<body>
	...
	<div class="container">
		<div class="jumbotron">
			...
			<c:choose>
				<c:when test="${userid != null}">
				<p class="text-left"><a class="btn btn-primary btn-lg" href="TeamMakeForm.do" role="button">팀 만들러 가기</a></p>	
				</c:when>
				<c:when test="${userid == null}">
				<p class="text-left"><a class="btn btn-primary btn-lg" href="#" role="button">팀 만들러 가기</a></p>
				</c:when>
			</c:choose>
		</div> 
