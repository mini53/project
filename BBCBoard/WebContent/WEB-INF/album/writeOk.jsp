...
<!-- 코드를 주고 싶으면 여기 주면 됌 -->
		<div align="center">
		<a href="javascript:viewArticle('${bcode}', '${pg}', '${key}', '${word}', '${seq}');">
		<img src="${root}/img/board/b_wirtecf.gif" width="91" height="21" border="0" align="absmiddle" alt="작성한 글 확인" hspace="10">
			</a>
			<a href="javascript:listArticle('${bcode}', '${pg}', '${key}', '${word}');">
				<img src="${root}/img/board/poll_listbu1.gif" width="62" height="21" border="0" align="absmiddle" alt="목록보기" hspace="10">
			</a>
		</td>
	</tr>
</table>
